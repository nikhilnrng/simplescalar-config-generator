...
import sys
from config import Config, get_cache_sets, get_tag_bits
from estimator import Estimator, is_area_valid, is_transistor_count_valid
from cacti import Cacti, cache_latency
...
DL1_BSIZE = 32
DL1_ASSOC = 4
DL1_NSETS = get_cache_sets(DL1_SIZE, DL1_BSIZE, DL1_ASSOC)
DL1_TAG_BITS = get_tag_bits(DL1_NSETS, DL1_BSIZE)

# Updated DL2 Cache Parameters
DL2_SIZE = 2097152
DL2_BSIZE = 64
DL2_ASSOC = 4
DL2_NSETS = get_cache_sets(DL2_SIZE, DL2_BSIZE, DL2_ASSOC)
DL2_TAG_BITS = get_tag_bits(DL2_NSETS, DL2_BSIZE)

# Updated IL1 Cache Parameters
IL1_SIZE = 32768
IL1_BSIZE = 64
IL1_ASSOC = 4
IL1_NSETS = get_cache_sets(IL1_SIZE, IL1_BSIZE, IL1_ASSOC)
IL1_TAG_BITS = get_tag_bits(IL1_NSETS, IL1_BSIZE)
...
# Check validity of transistor and area counts
TOT_TRANSISTOR_COUNT = estimator.get_transistor_count()
TOT_AREA = estimator.get_area()
if not is_transistor_count_valid(TOT_TRANSISTOR_COUNT) or not is_area_valid(TOT_AREA):
...
RUU_ACCESS_TIME = cacti.get_ruu_access_time([TOT_RUU_BITS,
                                             RUU_RPORTS,
                                             RUU_WPORTS,
                                             NUM_READOUT_BITS])

IL1_ACCESS_TIME = cacti.get_cache_access_time(['IL1',
                                               TOT_IL1_BITS,
                                               IL1_BSIZE,
                                               IL1_ASSOC,
                                               IL1_RPORTS,
...
DL1_ACCESS_TIME = cacti.get_cache_access_time(['DL1',
                                               TOT_DL1_BITS,
                                               DL1_BSIZE,
                                               DL1_ASSOC,
                                               DL1_RPORTS,
...
DL2_ACCESS_TIME = cacti.get_cache_access_time(['DL2',
                                               TOT_DL2_BITS,
                                               DL2_BSIZE,
                                               DL2_ASSOC,
                                               DL2_RPORTS,
...
IL1_LATENCY = cache_latency('IL1', IL1_ACCESS_TIME, RUU_ACCESS_TIME)
IL2_LATENCY = cache_latency('IL2', DL2_ACCESS_TIME, RUU_ACCESS_TIME)
DL1_LATENCY = cache_latency('DL1', DL1_ACCESS_TIME, RUU_ACCESS_TIME)
DL2_LATENCY = cache_latency('DL2', DL2_ACCESS_TIME, RUU_ACCESS_TIME)
